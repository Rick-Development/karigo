...
import 'package:karingo_v2/features/address/domain/services/address_service.dart';
import 'package:karingo_v2/features/address/domain/services/address_service_interface.dart';
...
import 'package:karingo_v2/features/auth/domain/repositories/auth_repository.dart';
import 'package:karingo_v2/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:karingo_v2/features/auth/domain/services/auth_service.dart';
...
import 'package:karingo_v2/features/banner/domain/repositories/banner_repository.dart';
import 'package:karingo_v2/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:karingo_v2/features/banner/domain/services/banner_service.dart';
import 'package:karingo_v2/features/banner/domain/services/banner_service_interface.dart';
import 'package:karingo_v2/features/brand/domain/repositories/brand_repo_interface.dart';
import 'package:karingo_v2/features/brand/domain/repositories/brand_repository.dart';
import 'package:karingo_v2/features/brand/domain/services/brand_service.dart';
import 'package:karingo_v2/features/brand/domain/services/brand_service_interface.dart';
import 'package:karingo_v2/features/cart/domain/repositories/cart_repository.dart';
import 'package:karingo_v2/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:karingo_v2/features/cart/domain/services/cart_service.dart';
import 'package:karingo_v2/features/cart/domain/services/cart_service_interface.dart';
import 'package:karingo_v2/features/category/domain/repositories/category_repo.dart';
import 'package:karingo_v2/features/category/domain/repositories/category_repo_interface.dart';
import 'package:karingo_v2/features/category/domain/services/category_service.dart';
import 'package:karingo_v2/features/category/domain/services/category_service_interface.dart';
import 'package:karingo_v2/features/chat/domain/repositories/chat_repository.dart';
import 'package:karingo_v2/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:karingo_v2/features/chat/domain/services/chat_service.dart';
import 'package:karingo_v2/features/chat/domain/services/chat_service_interface.dart';
import 'package:karingo_v2/features/checkout/controllers/checkout_controller.dart';
import 'package:karingo_v2/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:karingo_v2/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:karingo_v2/features/checkout/domain/services/checkout_service.dart';
...
import 'package:karingo_v2/features/compare/domain/repositories/compare_repository.dart';
import 'package:karingo_v2/features/compare/domain/repositories/compare_repository_interface.dart';
import 'package:karingo_v2/features/compare/domain/services/compare_service.dart';
import 'package:karingo_v2/features/compare/domain/services/compare_service_interface.dart';
import 'package:karingo_v2/features/contact_us/controllers/contact_us_controller.dart';
import 'package:karingo_v2/features/contact_us/domain/repository/contact_us_repository.dart';
import 'package:karingo_v2/features/contact_us/domain/repository/contact_us_repository_interface.dart';
import 'package:karingo_v2/features/contact_us/domain/services/contact_us_service.dart';
import 'package:karingo_v2/features/contact_us/domain/services/contact_us_service_interface.dart';
import 'package:karingo_v2/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:karingo_v2/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:karingo_v2/features/coupon/domain/services/coupon_service.dart';
import 'package:karingo_v2/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:karingo_v2/features/address/domain/repositories/address_repository.dart';
...
import 'package:karingo_v2/features/deal/domain/repositories/featured_deal_repository.dart';
import 'package:karingo_v2/features/deal/domain/repositories/featured_deal_repository_interface.dart';
import 'package:karingo_v2/features/deal/domain/repositories/flash_deal_repository.dart';
import 'package:karingo_v2/features/deal/domain/repositories/flash_deal_repository_interface.dart';
import 'package:karingo_v2/features/deal/domain/services/featured_deal_service.dart';
import 'package:karingo_v2/features/deal/domain/services/featured_deal_service_interface.dart';
import 'package:karingo_v2/features/deal/domain/services/flash_deal_service.dart';
import 'package:karingo_v2/features/deal/domain/services/flash_deal_service_interface.dart';
import 'package:karingo_v2/features/location/controllers/location_controller.dart';
import 'package:karingo_v2/features/location/domain/repositories/location_repository.dart';
import 'package:karingo_v2/features/location/domain/repositories/location_repository_interface.dart';
import 'package:karingo_v2/features/location/domain/services/location_service.dart';
import 'package:karingo_v2/features/location/domain/services/location_service_interface.dart';
import 'package:karingo_v2/features/loyaltyPoint/controllers/loyalty_point_controller.dart';
import 'package:karingo_v2/features/loyaltyPoint/domain/repositories/loyalty_point_repository_interface.dart';
import 'package:karingo_v2/features/loyaltyPoint/domain/services/loyalty_poin_service.dart';
import 'package:karingo_v2/features/loyaltyPoint/domain/services/loyalty_point_service_interface.dart';
import 'package:karingo_v2/features/notification/controllers/notification_controller.dart';
import 'package:karingo_v2/features/notification/domain/repositories/notification_repository.dart';
import 'package:karingo_v2/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:karingo_v2/features/notification/domain/services/notification_service.dart';
import 'package:karingo_v2/features/notification/domain/services/notification_service_interface.dart';
import 'package:karingo_v2/features/onboarding/controllers/onboarding_controller.dart';
import 'package:karingo_v2/features/onboarding/domain/repositories/onboarding_repository.dart';
import 'package:karingo_v2/features/onboarding/domain/repositories/onboarding_repository_interface.dart';
import 'package:karingo_v2/features/onboarding/domain/services/onboarding_service.dart';
...
import 'package:karingo_v2/features/order/domain/repositories/order_repository.dart';
import 'package:karingo_v2/features/order/domain/repositories/order_repository_interface.dart';
import 'package:karingo_v2/features/order/domain/services/order_service.dart';
...
import 'package:karingo_v2/features/order_details/domain/repositories/order_details_repository.dart';
import 'package:karingo_v2/features/order_details/domain/repositories/order_details_repository_interface.dart';
import 'package:karingo_v2/features/order_details/domain/services/order_details_service.dart';
import 'package:karingo_v2/features/order_details/domain/services/order_details_service_interface.dart';
...
import 'package:karingo_v2/features/product/domain/repositories/product_repository.dart';
import 'package:karingo_v2/features/product/domain/repositories/product_repository_interface.dart';
import 'package:karingo_v2/features/product/domain/repositories/seller_product_repository.dart';
import 'package:karingo_v2/features/product/domain/repositories/seller_product_repository_interface.dart';
import 'package:karingo_v2/features/product/domain/services/product_service.dart';
import 'package:karingo_v2/features/product/domain/services/product_service_interface.dart';
import 'package:karingo_v2/features/product/domain/services/seller_product_service.dart';
...
import 'package:karingo_v2/features/product_details/domain/repositories/product_details_repository.dart';
import 'package:karingo_v2/features/product_details/domain/repositories/product_details_repository_interface.dart';
import 'package:karingo_v2/features/product_details/domain/services/product_details_service.dart';
...
import 'package:karingo_v2/features/profile/domain/repositories/profile_repository.dart';
import 'package:karingo_v2/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:karingo_v2/features/profile/domain/services/profile_service.dart';
import 'package:karingo_v2/features/profile/domain/services/profile_service_interface.dart';
import 'package:karingo_v2/features/refund/controllers/refund_controller.dart';
import 'package:karingo_v2/features/refund/domain/repositories/refund_repository.dart';
import 'package:karingo_v2/features/refund/domain/repositories/refund_repository_interface.dart';
import 'package:karingo_v2/features/refund/domain/services/refund_service.dart';
import 'package:karingo_v2/features/refund/domain/services/refund_service_interface.dart';
import 'package:karingo_v2/features/reorder/controllers/re_order_controller.dart';
import 'package:karingo_v2/features/reorder/domain/repositories/re_order_repository.dart';
import 'package:karingo_v2/features/reorder/domain/repositories/re_order_repository_interface.dart';
import 'package:karingo_v2/features/reorder/domain/services/re_order_service.dart';
...
import 'package:karingo_v2/features/review/domain/repositories/review_repository.dart';
import 'package:karingo_v2/features/review/domain/repositories/review_repository_interface.dart';
import 'package:karingo_v2/features/review/domain/services/review_service.dart';
import 'package:karingo_v2/features/review/domain/services/review_service_interface.dart';
import 'package:karingo_v2/features/search_product/domain/repositories/search_product_repository_interface.dart';
import 'package:karingo_v2/features/search_product/domain/services/search_product_service.dart';
import 'package:karingo_v2/features/search_product/domain/services/search_product_service_interface.dart';
import 'package:karingo_v2/features/shipping/controllers/shipping_controller.dart';
import 'package:karingo_v2/features/shipping/domain/repositories/shipping_repository.dart';
import 'package:karingo_v2/features/shipping/domain/repositories/shipping_repository_interface.dart';
import 'package:karingo_v2/features/shipping/domain/services/shipping_service.dart';
import 'package:karingo_v2/features/shipping/domain/services/shipping_service_interface.dart';
import 'package:karingo_v2/features/shop/domain/repositories/shop_repository.dart';
import 'package:karingo_v2/features/shop/domain/repositories/shop_repository_interface.dart';
import 'package:karingo_v2/features/shop/domain/services/shop_service.dart';
import 'package:karingo_v2/features/shop/domain/services/shop_service_interface.dart';
import 'package:karingo_v2/features/splash/controllers/splash_controller.dart';
import 'package:karingo_v2/features/splash/domain/repositories/splash_repository.dart';
import 'package:karingo_v2/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:karingo_v2/features/splash/domain/services/splash_service.dart';
import 'package:karingo_v2/features/splash/domain/services/splash_service_interface.dart';
import 'package:karingo_v2/features/support/controllers/support_ticket_controller.dart';
import 'package:karingo_v2/features/support/domain/repositories/support_ticket_repository.dart';
import 'package:karingo_v2/features/support/domain/repositories/support_ticket_repository_interface.dart';
import 'package:karingo_v2/features/support/domain/services/support_ticket_service.dart';
import 'package:karingo_v2/features/support/domain/services/support_ticket_service_interface.dart';
import 'package:karingo_v2/features/wallet/controllers/wallet_controller.dart';
import 'package:karingo_v2/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:karingo_v2/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:karingo_v2/features/wallet/domain/services/wallet_service.dart';
...
import 'package:karingo_v2/features/wishlist/domain/repositories/wishlist_repository.dart';
import 'package:karingo_v2/features/wishlist/domain/repositories/wishlist_repository_interface.dart';
import 'package:karingo_v2/features/wishlist/domain/services/wishlist_service.dart';
import 'package:karingo_v2/features/wishlist/domain/services/wishlist_service_interface.dart';
