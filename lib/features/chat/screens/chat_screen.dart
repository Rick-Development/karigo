...
import 'package:karingo_v2/features/chat/domain/models/message_body.dart';
...
import 'package:karingo_v2/features/chat/widgets/chat_shimmer_widget.dart';
import 'package:karingo_v2/features/chat/widgets/message_bubble_widget.dart';
                                ...
                                return  Column(mainAxisSize: MainAxisSize.min, children: [
                                  ...
                                  ListView.builder(
                                    ...
                                    itemCount: chatProvider.messageList[index].length,
                                      ...
                                      if(subIndex !=0){
                                        return MessageBubbleWidget(message: chatProvider.messageList[index][subIndex], previous: chatProvider.messageList[index][subIndex-1],);
                                      }else{
