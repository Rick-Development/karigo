...
import 'package:karingo_v2/features/loyaltyPoint/widget/how_to_use_dialog_widget.dart';
        ...
        builder: (context, profile,_) {
          return Stack(children: [
            ...
            Positioned(left: 10,top: 25,
              child: Padding(padding: const EdgeInsets.only(top: Dimensions.paddingSizeDefault),
                child: IconButton(icon: const Icon(CupertinoIcons.back, color: ColorResources.hintTextColor),
