...
import 'package:karingo_v2/features/search_product/widgets/partial_matched_widget.dart';
...
import 'package:karingo_v2/features/compare/widgets/remove_compare_list_bottom_sheet_widget.dart';
import 'package:karingo_v2/features/compare/widgets/custom_top_sheet_widget.dart';
            ...
            ClipRRect(borderRadius: const BorderRadius.all(Radius.circular(Dimensions.paddingSizeSmall)),
              child: Container(
                decoration: BoxDecoration(
                  border: Border.all(color: Provider.of<ThemeController>(context, listen: false).darkTheme? Theme.of(context).hintColor.withOpacity(.5) : Theme.of(context).primaryColor.withOpacity(.25), width: .5),
                                  ...
                                  borderRadius: BorderRadius.circular(30)),
                                    width: 30, height:30, child: Padding(
                                      ...
                                      child: Image.asset(Images.search,
                                          color: Provider.of<ThemeController>(context, listen: false).darkTheme? Theme.of(context).hintColor : Theme.of(context).primaryColor.withOpacity(.25))))),
                            ))
                      ],
                    ),
