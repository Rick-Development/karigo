...
class TitleRowWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(children: [
      ...
      if(eventDuration != null)
      Container(width: MediaQuery.of(context).size.width, height: ResponsiveHelper.isTab(context)? MediaQuery.of(context).size.width/6.5 : 80,
      ...
      if(eventDuration != null && !Provider.of<ThemeController>(context, listen: false).darkTheme)
        Positioned(bottom: -20,left: -6,
            child: SizedBox(width: 60, child: Image.asset(Images.currentShape,
              opacity: const AlwaysStoppedAnimation(.05),))),

      if(eventDuration != null && !Provider.of<ThemeController>(context, listen: false).darkTheme)
      Positioned(top: -1,left: MediaQuery.of(context).size.width/3.3,
          child: SizedBox(width: 35, child: Image.asset(Images.currentShape,
            opacity: const AlwaysStoppedAnimation(.15),))),

      if(eventDuration != null && !Provider.of<ThemeController>(context, listen: false).darkTheme)
      Positioned(right: -2,top: -10,
          child: SizedBox(width: 25, child: Image.asset(Images.currentShape,
      ...
      Positioned(
        child: Align(alignment: Alignment.center,
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Padding(padding:  EdgeInsets.only(left: Provider.of<LocalizationController>(context, listen: false).isLtr? Dimensions.homePagePadding :0,
                  right: Provider.of<LocalizationController>(context, listen: false).isLtr? 0: Dimensions.homePagePadding ),
                child: Text(title!, style: titleHeader.copyWith(fontSize: Dimensions.fontSizeLarge,
                    ...
                    child: InkWell(onTap: onTap as void Function()?,
                      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            isDetailsPage == null ? Text(getTranslated('VIEW_ALL', context)!,
                                style: titilliumRegular.copyWith(color: Provider.of<ThemeController>(context, listen: false).darkTheme?
          ...
          children: [
            Container(width: 28,height: 28,
              ...
              decoration: BoxDecoration(
                ...
                Theme.of(context).primaryColor.withOpacity(.12) : Colors.white,
            ...
            Padding(padding: const EdgeInsets.only(top: 4.0),
              child: Text(day!, style: textMedium.copyWith(color: isDetailsPage != null ?
